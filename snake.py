...
def gameloop():
    ...
    while not game_over:
        ...
        pygame.draw.rect(win,green,[foodx,foody,snake_block,snacke_block])
        snake_Head=[]
        sneaKe_Head.append(y1)
        sneaKe_Head.append(x1)
        sneaKe_Head.append(snake_Head)
